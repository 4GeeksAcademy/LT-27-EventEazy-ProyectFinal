                                    ...
                                    <div className="product-card-inner">
                                        ...
                                        <div className="product-details">
                                            ...
                                            <div className="product-actions justify-content-end mt-5">
                                                ...
                                                <div className="buttons-editDelete">
                                                    <i role="button" onClick={() => navigate("/edit-product/" + product.id)} className="bi bi-pen-fill edit-icon"></i>
                                                    <i role="button" onClick={() => actions.deleteProduct(product.id)} className="bi bi-trash-fill delete-icon"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
