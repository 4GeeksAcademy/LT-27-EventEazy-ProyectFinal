    ...
    return (
        <nav className="navbar" style={{backgroundColor: '#e3f2fd'}}>
            <div className="container">
                ...
                <Link className="nav-link active" aria-current="page" to="/profile-company">Profile Company</Link> 
                <Link className="nav-link active" aria-current="page" to="/profile-user">Profile User</Link>          
